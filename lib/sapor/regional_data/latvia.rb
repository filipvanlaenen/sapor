...
module Sapor
  ...
  class LatviaWithLpvLukRAndS < Latvia
    ...
    def election_results_of_2018
      if @election_results_of_2018.nil?
        @election_results_of_2018 = load_election_results(
          'latvia-20181006-with-lpv-luk-r-and-s.psv'
        )
      end
      @election_results_of_2018
    end
  ...
  # Extension of Latvia with LPV, LuK, R, S and SV
  class LatviaWithLpvLukRSAndSv < Latvia
    def area_code
      'LV∪{LPV,LuK,R,S,SV}'
    end
    ...
    def election_results_of_2018
      if @election_results_of_2018.nil?
        @election_results_of_2018 = load_election_results(
          'latvia-20181006-with-lpv-luk-r-s-and-sv.psv'
        )
      end
      @election_results_of_2018
    end
  ...
  # Extension of Latvia with LPV, LuK, S and SV
  class LatviaWithLpvLukSAndSv < Latvia
    def area_code
      'LV∪{LPV,LuK,S,SV}'
    end
    ...
    def election_results_of_2018
      if @election_results_of_2018.nil?
        @election_results_of_2018 = load_election_results(
          'latvia-20181006-with-lpv-luk-s-and-sv.psv'
        )
      end
      @election_results_of_2018
    end
