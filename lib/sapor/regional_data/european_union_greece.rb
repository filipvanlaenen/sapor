...
module Sapor
  ...
  class EuropeanUnionGreece < Area
    ...
    COALITIONS = [['Ανεξάρτητοι Έλληνες (ECR)', 'Ελληνική Λύση (ECR)'],
                  ['Αντικαπιταλιστική Αριστερή Συνεργασία για την Ανατροπή (*)', 'Δημοκρατικό Πατριωτικό Κίνημα ΝΙΚΗ (*)',
                   'ΕΑΝ… (*)', 'Εθνικό Κόμμα – Έλληνες (*)', 'Πλεύση Ελευθερίας (*)', 'Σπαρτιάτες (*)',
                   'Φωνή Λογικής (*)'],
                  ...
                  ['Λαϊκή Ενότητα (GUE/NGL)',
                   'Μέτωπο Ευρωπαϊκής Ρεαλιστικής Ανυπακοής (GUE/NGL)', 'Νέα Αριστερά (GUE/NGL)',
