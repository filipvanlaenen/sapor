...
module Sapor
  ...
  class EuropeanUnionBulgaria < Area
    ...
    COALITIONS = [['Сияние (Greens/EFA)'],
                  ...
                  ['Българските патриоти (ECR)', 'ВМРО–Българско Национално Движение (ECR)',
                   'Движение за права и свободи (ECR)', 'Има такъв народ (ECR)', 'Обединени Патриоти (ECR)',
                   'Синя България (ECR)'],
