...
module Sapor
  ...
  class Poll
    ...
    EUROPEAN_UNION_720_AREAS = [EuropeanUnion720Denmark.instance,
                                ...
                                EuropeanUnion720Slovenia.instance,
                                EuropeanUnion720Spain.instance].freeze
    ...
    (BELGIAN_AREAS + EUROPEAN_UNION_AREAS + EUROPEAN_UNION_720_AREAS + NORWEGIAN_AREAS + POLISH_AREAS + \
     [Austria.instance, Bulgaria.instance, Catalonia.instance,
      ...
      Cyprus.instance, Denmark.instance, Estonia.instance, Finland.instance,
      ...
      ScotlandWithAfuAndAlba.instance, ScotlandWithAlba.instance,
      ScotlandWithAlbaAndRefUK.instance, ScotlandWithRefUK.instance,
