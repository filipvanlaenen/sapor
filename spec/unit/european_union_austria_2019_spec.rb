...
describe Sapor::EuropeanUnionAustria2019, '#area_code' do
  it 'returns EU[AT]@2019 as the area code' do
    expect(Sapor::EuropeanUnionAustria2019.instance.area_code).to eq('EU[AT]@2019')
  end
end

describe Sapor::EuropeanUnionAustria2019, '#no_of_seats' do
  it 'returns 19 as the number of seats' do
    expect(Sapor::EuropeanUnionAustria2019.instance.no_of_seats).to eq(19)
  end
end

describe Sapor::EuropeanUnionAustria2019, '#population_size' do
  it 'returns a population size of 2,823,561' do
    expect(Sapor::EuropeanUnionAustria2019.instance.population_size).to \
      eq(2_823_561)
  end
end

describe Sapor::EuropeanUnionAustria2019, '#seats' do
  it 'calculates the number of seats for the election of 2014' do
    ...
    seats = Sapor::EuropeanUnionAustria2019.instance.seats(results)
    expect(seats['Österreichische Volkspartei (EPP)']).to eq(5 + 1)
