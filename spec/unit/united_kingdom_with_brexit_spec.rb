...
describe Sapor::UnitedKingdomWithBrexit, '#area_code' do
  it 'returns UK∪{BREXIT} as the area code' do
    expect(Sapor::UnitedKingdomWithBrexit.instance.area_code).to eq('UK∪{BREXIT}')
  end
end

describe Sapor::UnitedKingdomWithBrexit, '#no_of_seats' do
  it 'returns 650 as the number of seats' do
    expect(Sapor::UnitedKingdomWithBrexit.instance.no_of_seats).to eq(650)
  end
end

describe Sapor::UnitedKingdomWithBrexit, '#population_size' do
  it 'returns a population size of 32,204,124' do
    expect(Sapor::UnitedKingdomWithBrexit.instance.population_size).to eq(32_204_124)
  end
end

describe Sapor::UnitedKingdomWithBrexit, '#seats' do
  it 'calculates the number of seats for the election of 8 June 2017' do
    uk = Sapor::UnitedKingdomWithBrexit.instance
...
describe Sapor::UnitedKingdomWithBrexit, '#threshold' do
  it 'returns there is no threshold' do
    expect(Sapor::UnitedKingdomWithBrexit.instance.threshold).to be_nil
  end
end
