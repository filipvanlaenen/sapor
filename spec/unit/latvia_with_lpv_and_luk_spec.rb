...
describe Sapor::LatviaWithLpvAndLuk, '#area_code' do
  it 'returns LV∪{LPV,LuK} as the area code' do
    expect(Sapor::LatviaWithLpvAndLuk.instance.area_code).to eq('LV∪{LPV,LuK}')
  end
end

describe Sapor::LatviaWithLpvAndLuk, '#no_of_seats' do
  it 'returns 100 as the number of seats' do
    expect(Sapor::LatviaWithLpvAndLuk.instance.no_of_seats).to eq(100)
  end
end

describe Sapor::LatviaWithLpvAndLuk, '#population_size' do
  it 'returns a population size of 839,000' do
    expect(Sapor::LatviaWithLpvAndLuk.instance.population_size).to eq(839_000)
  end
end
