...
describe Sapor::EuropeanUnion720Latvia, '#area_code' do
  it 'returns EU720[LV] as the area code' do
    expect(Sapor::EuropeanUnion720Latvia.instance.area_code).to eq('EU720[LV]')
  end
end

describe Sapor::EuropeanUnion720Latvia, '#no_of_seats' do
  it 'returns 9 as the number of seats' do
    expect(Sapor::EuropeanUnion720Latvia.instance.no_of_seats).to eq(9)
  end
end

describe Sapor::EuropeanUnion720Latvia, '#seats' do
  it 'calculates the number of seats for the election of 2014' do
    results = { 'Vienotība (EPP)' => 204_979,
                'Nacionālā apvienība „Visu Latvijai!”–„Tēvzemei un ' \
                  'Brīvībai/LNNK” (ECR)' => 63_229,
                ...
                'Par prezidentālu republiku (*)' => 672,
                'Suverenitāte (*)' => 599 }
    seats = Sapor::EuropeanUnion720Latvia.instance.seats(results)
